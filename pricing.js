function calculateltd (product,price,employee){ var salaryPercentage = product.coveragePercentage / 100
...
function calculatevolLife (coverageLevels, price,product){ for (var i = 0; i < coverageLevels.length; i++) {
